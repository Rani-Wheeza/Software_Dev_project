namespace BabysittingSYS
{
    partial class frm_AddSitter
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.bnEnterDetails.Click += new System.EventHandler(this.bnEnterDetails_Click);
            // 
            // txt_LastName
            // 
            ...
            this.GB_AddSitterDetails.Controls.Add(this.txt_SitterID);
            this.GB_AddSitterDetails.Controls.Add(this.txt_Eircode);
            this.GB_AddSitterDetails.Controls.Add(this.txt_Town);
            this.GB_AddSitterDetails.Controls.Add(this.txt_Street);
            this.GB_AddSitterDetails.Controls.Add(this.txt_PhoneNo);
            this.GB_AddSitterDetails.Controls.Add(this.txt_FirstName);
            this.GB_AddSitterDetails.Controls.Add(this.lb_SitterID);
            this.GB_AddSitterDetails.Controls.Add(this.lb_Eircode);
            this.GB_AddSitterDetails.Controls.Add(this.lb_Town);
            this.GB_AddSitterDetails.Controls.Add(this.lb_Street);
            this.GB_AddSitterDetails.Controls.Add(this.lb_PhoneNo);
            ...
            this.GB_AddSitterDetails.ResumeLayout(false);
            this.GB_AddSitterDetails.PerformLayout();
